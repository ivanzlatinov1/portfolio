        ...
        <div className="relative flex-1 overflow-y-auto px-4 py-3 flex flex-col gap-3">
            ...
            {messages.map((m, i) => (
                ...
                >
                    ...
                    (i === 0 || messages[i - 1].role === 'user') ? (
                        <img
                            className="w-7 h-7 rounded-full object-cover border border-cyan-500/50 shrink-0 mb-1"
                            src={profileImg}
                            style={{
                    ...
                    <div
                        className={`max-w-[72%] font-mono rounded-2xl px-4 py-2.5 text-sm text-left leading-6 ${
                            m.role === 'user'
            ...
            {loading && (
                <div className="flex items-end gap-2">
                    ...
                    />
                    <div
                        className="rounded-2xl rounded-bl-sm px-4 py-2.5 text-sm text-slate-400 border border-cyan-500/20"
                        style={{
                            background:
                                'linear-gradient(135deg, #0f2744, #0a1e38)',
                        }}
