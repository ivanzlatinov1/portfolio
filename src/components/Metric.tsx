...
const Metric = ({ icon, stat, description, project }: MetricProps) => {
    return (
        <div
            className="group relative flex flex-col items-center gap-2 sm:gap-2.5 overflow-hidden rounded-xl
            border border-white/10 bg-white/5 p-4 sm:p-6 text-center backdrop-blur-sm
        ...
        >
            ...
            <div className="flex h-9 w-9 sm:h-12 sm:w-12 items-center justify-center rounded-xl bg-cyan-500/10 transition-transform duration-200 group-hover:scale-110">
                <FontAwesomeIcon
                    {...icon}
            ...
            <p className="text-xl sm:text-2xl font-medium text-white transition-colors duration-200 group-hover:text-cyan-400">
                {stat}
            </p>
            ...
            <p
                className="translate-y-1 rounded-full bg-cyan-500/10 px-2 sm:px-2.5 py-0.5 text-[10px] sm:text-xs text-cyan-400
